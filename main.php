...
<div style='position:fixed;width:100%;z-index: 1;height:100%;' id="mainDiv">
    <div id="header">
        <center><h2>CI REGRESSION REPORT</h2></center>
</div>
<div  id="main">
    <ul>
...
<div id="report-sub" style="display:none;">
    <ul style="display: none;" id="tabnav">
        ...
        $dbh = pg_connect("host=jdi-reg-tools password =postgres dbname=regression user=postgres");
         if (!$dbh) {
...
<div id='summary_disp' >
    ...
    <iframe src="http://jdi-reg-tools.juniper.net/CI_Report/reg/" style="width:100%;height:90%;" frameborder="0"></iframe>
...
<center>
    <div id='configinput' style='position:absolute;width:100%;top:200px;display:none;z-index:200'>
        ...
        <tr>
            ...
            <td>
                <select id='selfunct' name="selfunct">
                    ...
                    <option name="Switching">Switching</option>
                    <option name="Platform">Platform</option>
                    <option name="PFE">PFE</option>
                    <option name="Platform-PFE">Platform-PFE</option>
                    ...
                    <option name="QFX-VBrackla">QFX-VBrackla</option>
                    <option name="PTX-VBrackla">PTX-VBrackla</option>
                    <option name="PTX-Brackla">PTX-Brackla</option>
                    <option name="QFX-Brackla">QFX-Brackla</option>
                    <option name="QFX-Nautilus">QFX-Nautilus</option>
                    <option name="QFX-Sapphire">QFX-Sapphire</option>
        ...
        <table border=1>
            ...
            <tr>
                <td>Choose a Release type</td>
                  <td>
                    <select id='rel_tag' name="rel_tag">
                        <option name="r_rel" value="r_rel">Enter Release Type</option>
                        <option name="ser_rel" value="ser_rel">Service-Release</option>
                        <option name="dev" value="dev">Other-Release(dev)</option>
                        <option name="x_rel" value="x_rel">X-Release</option>
                        <option name="r_rel" value="r_rel">R-Release</option>
                    </select>
                </td>
            </tr>
