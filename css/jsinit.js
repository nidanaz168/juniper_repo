...
function getpage(tab)
{
    ...
    {
		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/data/index.mhtml";
    ...
    else if(tab.search(/sol-regprof/i) >=0)
    {

		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/data/construction.html"
        str = ajaxrequest("libs/readfile.php?file="+file);
        $("#content-display").html(respcontent);
    }
    ...
    else if(tab.search(/utilization/i) >=0)
    {

		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/data/utilization.html";
        str = ajaxrequest("libs/readfile.php?file="+file);
        $("#content-display").html(respcontent);
		util_init();
    }
	...
	else if(tab.search(/qos/i) >=0)
	{
		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/plan/hardening/qos.html"
		str = ajaxrequest("libs/readfile.php?file="+file);
		$("#content-display").html(respcontent);
	}
	else if(tab.search(/mpls/i) >=0)
	{
		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/plan/hardening/MPLS.html"
		str = ajaxrequest("libs/readfile.php?file="+file);
		$("#content-display").html(respcontent);
	}
	else if(tab.search(/interfaces/i) >=0)
	{
		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/plan/hardening/interfaces.html"
		str = ajaxrequest("libs/readfile.php?file="+file);
		$("#content-display").html(respcontent);
	}
	else if(tab.search(/multicast/i) >=0)
	{
		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/plan/hardening/multicast.html"
		str = ajaxrequest("libs/readfile.php?file="+file);
		$("#content-display").html(respcontent);
	}
	else if(tab.search(/ethernet/i) >=0)
	{
		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/plan/hardening/ethernet.html"
		str = ajaxrequest("libs/readfile.php?file="+file);
		$("#content-display").html(respcontent);
	}
	else if(tab.search(/firewall/i) >=0)
	{
		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/plan/hardening/firewall.html"
		str = ajaxrequest("libs/readfile.php?file="+file);
		$("#content-display").html(respcontent);
	}
	else if(tab.search(/fabric/i) >=0)
	{
		file = "/homes/rod/public_html/EABU-MMX-TEST-GOALS/plan/hardening/fabric/fabric.html"
		str = ajaxrequest("libs/readfile.php?file="+file);
		$("#content-display").html(respcontent);
	}
	else if(tab.search(/reg/i) >=0)
	{
		file = "/homes/rod/public_html/RegReport/makereport/prinfo.html"
		str = ajaxrequest("libs/readfile.php?file="+file);
		$("#content-display").html(respcontent);
	}
...
function activate_sub_menu(parent)
{
	if(parent.search(/hard/i) >=0)
	{
		$("#hard-mclag").addClass("ui-state-active");
		$("#hard-mpls").removeClass("ui-state-active ui-tabs-selected");
		$("#hard-qos").removeClass("ui-state-active ui-tabs-selected");
		$("#hard-interfaces").removeClass("ui-state-active ui-tabs-selected");
		$("#hard-muticast").removeClass("ui-state-active ui-tabs-selected");
		$("#hard-ethernet").removeClass("ui-state-active ui-tabs-selected");
		$("#hard-fabric").removeClass("ui-state-active ui-tabs-selected");
		$("#hard-firewall").removeClass("ui-state-active ui-tabs-selected");
		$("#hard-mpls").addClass("ui-state-default");
		$("#hard-qos").addClass("ui-state-default");
		$("#hard-interfaces").addClass("ui-state-default");
		$("#hard-muticast").addClass("ui-state-default");
		$("#hard-ethernet").addClass("ui-state-default");
		$("#hard-fabric").addClass("ui-state-default");
		$("#hard-firewall").addClass("ui-state-default");
	}
	else if(parent.search(/regprof/i) >=0)
	{
		$("#rel-regprof1").addClass("ui-state-active ui-tabs-selected");
		$("#cust-regprof2").removeClass("ui-state-active ui-tabs-selected");
		$("#time-regprof3").removeClass("ui-state-active ui-tabs-selected");
		$("#sol-regprof4").removeClass("ui-state-active ui-tabs-selected");
		$("#plat-regprof5").removeClass("ui-state-active ui-tabs-selected");
		$("#cust-regprof2").addClass("ui-state-default");
		$("#time-regprof3").addClass("ui-state-default");
		$("#sol-regprof4").addClass("ui-state-default");
		$("#plat-regprof5").addClass("ui-state-default");
	}
	else if(parent.search(/report/i) >=0)
	{
		$("#sim").addClass("ui-state-active ui-tabs-selected");
		$("#sin").removeClass("ui-state-active ui-tabs-selected");
		$("#cfdc").removeClass("ui-state-active ui-tabs-selected");
		$("#regression").removeClass("ui-state-active ui-tabs-selected");
		$("#sin").addClass("ui-state-default");
		$("#cfdc").addClass("ui-state-default");
		$("#regression").addClass("ui-state-default");
	}
	else if(parent.search(/goals/i) >=0)
	{
		$("#teamgoal").addClass("ui-state-active ui-tabs-selected");
		$("#indgoal").removeClass("ui-state-active ui-tabs-selected");
		$("#indgoal").addClass("ui-state-default");
	}
			
}
function open_dr(dr)
{
	url= "http://systest.juniper.net/ti/webapp/dr/debug_dr/index.mhtml?mode=5:7:0&result_id="+dr;
                        window.open(url);
}               
function show_fabric(obj,displayid)
{
	$('.fabric').each(function () {
		var current = $(this);      
		var id = current.attr('id');
		$("#"+id).hide();
		$("#b"+id).css("background-color","58aa00");
	});
	$("#"+displayid).show();
	$("#b"+displayid).css("background-color","2c6da0");
