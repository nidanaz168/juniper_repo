...
<li id="report"><a  href="#report_disp" onclick="hideSummaryReport()"><span>Detailed Reports</span></a></li> 
<!-- <li id="config"><a  href="#config_disp"><span>Configuration</span></a></li> -->
<li id="config"><a  href="#config_disp" onclick="hideSummaryReport()"><span>Configuration</span></a></li>
</ul>
</div>
...
<div id='summary_disp'>
    ...
    <iframe src="https://jdiregression.juniper.net/autotools/dev/reg/" style="width:100%;height:90%;" frameborder="0"></iframe>
...
<br><br>
<div id='display' style='position:absolute;width:100%;left:10px'></div>
